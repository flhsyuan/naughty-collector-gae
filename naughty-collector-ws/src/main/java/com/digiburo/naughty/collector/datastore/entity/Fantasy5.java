 ...
 * fantasy5 container
 */
public class Fantasy5 extends AbstractEntity {
  public static final String ENTITY_NAME = "Fantasy5";
  ...
  public String toString() {
    return("Fantasy5:" + draw + ":" + value1 + ":" + value2 + ":" + value3 + ":" + value4 + ":" + value5 + ":" + date);
  }
}
/*
