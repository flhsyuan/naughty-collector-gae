...
/**
 * megamillion container
 */
public class MegaMillion extends AbstractEntity {
  public static final String ENTITY_NAME = "MegaMillion";
  ...
  public String toString() {
    return("MegaMillion:" + draw + ":" + value1 + ":" + value2 + ":" + value3 + ":" + value4 + ":" + value5 + ":" + mega + ":" + date);
  }
}
/*
